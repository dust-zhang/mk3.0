...
//     [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(pauseButtonClick) name:NOTIFITION_PAUSEPLAYVIDEO object:nil];
}
...
//    if (self.backPortraitBlock) {
//        self.backPortraitBlock();
//    }
//    
