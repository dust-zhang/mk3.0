...
@implementation SaleDiscountTableViewCell
...
-(void)layoutPacket:(SaleCellIndex)index
{
    ...
    {
        //第一个红包
        _imageLogo.frame = CGRectMake(15, 30, 50/2, 50/2);
        originY = 30;
    }
    ...
    if (index == indexSaleOnly || index == indexSaleLast)
    {
        //最后一个卡cell
