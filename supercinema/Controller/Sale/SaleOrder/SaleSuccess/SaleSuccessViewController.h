...
@interface SaleSuccessViewController : HideTabBarViewController <UITableViewDelegate, UITableViewDataSource, SmallSaleDescribeCellDelegate, UITextFieldDelegate, UIAlertViewDelegate>
{
    UITableView         *_tabViewSaleSuccess;
