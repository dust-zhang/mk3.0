...
NSString *const MJRefreshHeaderStateIdleText = @"下拉可以刷新";//下拉可以刷新
NSString *const MJRefreshHeaderStatePullingText = @"松开立即刷新";//松开立即刷新
NSString *const MJRefreshHeaderStateRefreshingText = @"正在刷新数据中...";//正在刷新数据中...
