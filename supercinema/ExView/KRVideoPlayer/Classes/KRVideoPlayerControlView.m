...
- (void)layoutSubviews
{
    ...
    self.topBar.frame = CGRectMake(CGRectGetMinX(self.bounds), 35/2, CGRectGetWidth(self.bounds), 50);
    
    self.closeButton.frame = CGRectMake(0, 0, 75, 50);
...
- (UIButton *)closeButton
{
    if (!_closeButton) {
        ...
        [_closeButton setImage:[UIImage imageNamed:@"btn_still_close.png"] forState:UIControlStateNormal];
        [_closeButton setBackgroundColor:[UIColor clearColor]];
//        [_closeButton setImage:[UIImage imageNamed:@"btn_close_selected.png"] forState:UIControlStateHighlighted];
...
- (UILabel *)timeLabel
{
    if (!_timeLabel) {
        ...
        _timeLabel.font = MKFONT(kVideoControlTimeLabelFontSize);
