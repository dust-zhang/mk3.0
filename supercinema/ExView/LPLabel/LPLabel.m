...
- (void)drawTextInRect:(CGRect)rect
{
    ...
    CGSize textSize =[Tool boundingRectWithSize:self.text textFont:self.font textSize:CGSizeMake(MAXFLOAT, self.font.lineHeight)]; //[[self text] sizeWithFont:[self font]];
